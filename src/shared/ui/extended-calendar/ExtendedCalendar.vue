...
import { CalendarCell, CalendarCellTrigger, CalendarGrid, CalendarGridBody, CalendarGridHead, CalendarGridRow, CalendarHeadCell, CalendarHeader, CalendarHeading } from '@/shared/ui/calendar'
import {
  Select,
  SelectContent,
  SelectItem,
...
const formatter = useDateFormatter('ru-RU')
</script>